...
// Fetch only biscuit products
$sql = "SELECT * FROM biscuit_products"; // Make sure this table exists
...
<body>
    <div class="heading">
        Explore Our Best homeware Products
    ...
    <div class="product-grid">
        <?php if ($result->num_rows > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p>No homeware products available.</p>
        <?php endif; ?>
        <?php $conn->close(); ?>
    </div>
